...
public:
    ...
    virtual StaticConstraint* checkContact(Particle& particle, const double dt) { return nullptr; }
...
public:
    ...
    StaticConstraint* checkContact(Particle& particle, const double dt) override;
